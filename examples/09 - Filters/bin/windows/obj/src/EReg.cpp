...
HX_DEFINE_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_30_new,"EReg","new",0x8b859e81,"EReg.new","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",30,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_38_match,"EReg","match",0x18fda1a6,"EReg.match","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",38,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_47_matched,"EReg","matched",0x8ce62f85,"EReg.matched","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",47,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_64_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",64,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_67_matchSub,"EReg","matchSub",0xbc75cb7a,"EReg.matchSub","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",67,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_76_split,"EReg","split",0x9749433b,"EReg.split","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",76,0x091d5469)
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_100_replace,"EReg","replace",0xae923ad5,"EReg.replace","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",100,0x091d5469)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8a1edfcee13c7cc1_151_map,"EReg","map",0x8b84d8bd,"EReg.map","C:\\coding\\haxe\\haxe\\std/cpp/_std/EReg.hx",151,0x091d5469)

void EReg_obj::__construct(::String r,::String opt){
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_30_new)
...
bool EReg_obj::match(::String s){
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_38_match)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_47_matched)
...
HX_DEFINE_DYNAMIC_FUNC1(EReg_obj,matched,return )
 ...
 ::Dynamic EReg_obj::matchedPos(){
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_64_matchedPos)
...
int len = __o_len.Default(-1);
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_67_matchSub)
HXLINE(  68)		int p;
...
::Array< ::String > EReg_obj::split(::String s){
            	HX_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_76_split)
...
::String EReg_obj::replace(::String s,::String by){
            	HX_GC_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_100_replace)
...
::String EReg_obj::map(::String s, ::Dynamic f){
            	HX_GC_STACKFRAME(&_hx_pos_8a1edfcee13c7cc1_151_map)
