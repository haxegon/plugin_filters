...
::haxegon::Key_obj::__register();
::haxegon::Keystate_obj::__register();
::lime::_hx_system::Endian_obj::__register();
::lime::utils::TAError_obj::__register();
::haxe::io::Error_obj::__register();
::haxe::StackItem_obj::__register();
::ValueType_obj::__register();
::starling::utils::SystemUtil_obj::__register();
::starling::utils::ScaleMode_obj::__register();
::starling::utils::RectangleUtil_obj::__register();
::starling::utils::Pool_obj::__register();
::starling::utils::MeshUtil_obj::__register();
::starling::utils::Max_obj::__register();
::starling::utils::MatrixUtil_obj::__register();
::starling::utils::MathUtil_obj::__register();
::starling::utils::Color_obj::__register();
::starling::utils::AssetManager_obj::__register();
::starling::utils::Align_obj::__register();
::starling::textures::TextureSmoothing_obj::__register();
::starling::textures::TextureAtlas_obj::__register();
::starling::textures::RenderTexture_obj::__register();
::starling::textures::ConcreteRectangleTexture_obj::__register();
::starling::textures::ConcretePotTexture_obj::__register();
::starling::textures::Texture_obj::__register();
::starling::text::TextFieldAutoSize_obj::__register();
::starling::text::MiniBitmapFont_obj::__register();
::starling::text::CharLocation_obj::__register();
::starling::text::BitmapFont_obj::__register();
::starling::text::TextField_obj::__register();
::starling::text::TrueTypeCompositor_obj::__register();
::starling::rendering::RenderState_obj::__register();
::starling::rendering::Program_obj::__register();
::starling::rendering::Painter_obj::__register();
::starling::rendering::BatchProcessor_obj::__register();
::starling::geom::Polygon_obj::__register();
::starling::filters::FilterQuad_obj::__register();
::starling::events::TouchProcessor_obj::__register();
::starling::events::TouchPhase_obj::__register();
::starling::events::TouchEvent_obj::__register();
::starling::events::Touch_obj::__register();
::starling::events::ResizeEvent_obj::__register();
::starling::events::KeyboardEvent_obj::__register();
::starling::events::EnterFrameEvent_obj::__register();
::starling::events::Event_obj::__register();
::starling::display::Stage_obj::__register();
::starling::display::MeshBatch_obj::__register();
::starling::display::Image_obj::__register();
::starling::display::BlendMode_obj::__register();
::starling::core::StatsDisplay_obj::__register();
::starling::core::Starling_obj::__register();
::starling::animation::Tween_obj::__register();
::starling::animation::Transitions_obj::__register();
::starling::animation::Juggler_obj::__register();
::starling::animation::DelayedCall_obj::__register();
...
::starling::filters::FragmentFilter_obj::__register();
::haxegon::embeddedassets::DefaultFont_obj::__register();
::haxegon::Text_obj::__register();
::haxegon::Sound_obj::__register();
::haxegon::Random_obj::__register();
::haxegon::Music_obj::__register();
::haxegon::Mouse_obj::__register();
::haxegon::Input_obj::__register();
::haxegon::Gfx_obj::__register();
::starling::rendering::IndexData_obj::__register();
::openfl::utils::_ByteArray::ByteArray_Impl__obj::__register();
::openfl::errors::Error_obj::__register();
::starling::rendering::VertexData_obj::__register();
::lime::_hx_system::System_obj::__register();
::openfl::utils::ByteArrayData_obj::__register();
::starling::display::Quad_obj::__register();
::starling::display::Mesh_obj::__register();
::starling::styles::MeshStyle_obj::__register();
::starling::rendering::MeshEffect_obj::__register();
::starling::rendering::FilterEffect_obj::__register();
::starling::rendering::Effect_obj::__register();
::starling::rendering::VertexDataFormat_obj::__register();
::haxegon::Geom_obj::__register();
::haxegon::Debug_obj::__register();
::haxegon::Data_obj::__register();
::haxegon::Core_obj::__register();
::starling::display::DisplayObjectContainer_obj::__register();
::starling::display::DisplayObject_obj::__register();
...
::starling::events::EventDispatcher_obj::__register();
::haxegon::Col_obj::__register();
...
::starling::utils::StringUtil_obj::__register();
::starling::utils::RenderUtil_obj::__register();
::starling::utils::Execute_obj::__register();
::starling::utils::ArrayUtil_obj::__register();
::starling::textures::SubTexture_obj::__register();
::starling::textures::ConcreteVideoTexture_obj::__register();
::starling::textures::ConcreteTexture_obj::__register();
::starling::textures::TextureOptions_obj::__register();
::starling::textures::AtfData_obj::__register();
::starling::text::BitmapDataEx_obj::__register();
::starling::text::TextFormat_obj::__register();
::starling::text::TextOptions_obj::__register();
::starling::text::ITextCompositor_obj::__register();
::starling::text::BitmapChar_obj::__register();
::starling::rendering::VertexDataAttribute_obj::__register();
::starling::rendering::BatchPool_obj::__register();
::starling::geom::Rectangle_obj::__register();
::starling::geom::Ellipse_obj::__register();
::starling::geom::ImmutablePolygon_obj::__register();
::starling::filters::FilterHelper_obj::__register();
::starling::filters::IFilterHelper_obj::__register();
::starling::events::TouchMarker_obj::__register();
::starling::errors::NotSupportedError_obj::__register();
::starling::errors::MissingContextError_obj::__register();
::starling::errors::AbstractMethodError_obj::__register();
::starling::errors::AbstractClassError_obj::__register();
::starling::utils::MeshSubset_obj::__register();
::starling::display::TextureSetupSettings_obj::__register();
::starling::utils::Padding_obj::__register();
::starling::display::Disk_obj::__register();
::starling::display::Ring_obj::__register();
::starling::animation::IAnimatable_obj::__register();
...
::haxegon::filters::BloomEffect_obj::__register();
::haxegon::filters::Bloomfilter_obj::__register();
::haxegon::Fontfile_obj::__register();
::haxegon::Fontclass_obj::__register();
::haxegon::HaxegonSound_obj::__register();
::haxegon::HaxegonChannel_obj::__register();
::haxegon::Scene_obj::__register();
::haxegon::S_obj::__register();
...
::starling::display::Line_obj::__register();
::starling::display::Poly4_obj::__register();
::haxegon::HaxegonTileset_obj::__register();
::haxegon::HaxegonImage_obj::__register();
::haxegon::Filter_obj::__register();
::starling::display::Sprite_obj::__register();
::starling::rendering::BatchToken_obj::__register();
...
::haxegon::Convert_obj::__register();
...
::haxegon::Key_obj::__boot();
::haxegon::Keystate_obj::__boot();
...
::haxegon::Col_obj::__boot();
::starling::events::EventDispatcher_obj::__boot();
::lime::math::Matrix3_obj::__boot();
::openfl::geom::Matrix_obj::__boot();
::openfl::geom::Point_obj::__boot();
::openfl::geom::Rectangle_obj::__boot();
::starling::display::DisplayObject_obj::__boot();
::starling::display::DisplayObjectContainer_obj::__boot();
::haxegon::Core_obj::__boot();
::haxegon::Data_obj::__boot();
::haxegon::Debug_obj::__boot();
::haxegon::Geom_obj::__boot();
::starling::rendering::VertexDataFormat_obj::__boot();
::starling::rendering::Effect_obj::__boot();
::starling::rendering::FilterEffect_obj::__boot();
::starling::rendering::MeshEffect_obj::__boot();
::starling::styles::MeshStyle_obj::__boot();
::starling::display::Mesh_obj::__boot();
::starling::display::Quad_obj::__boot();
::openfl::utils::ByteArrayData_obj::__boot();
::lime::_hx_system::System_obj::__boot();
::starling::rendering::VertexData_obj::__boot();
::openfl::errors::Error_obj::__boot();
::openfl::utils::_ByteArray::ByteArray_Impl__obj::__boot();
::starling::rendering::IndexData_obj::__boot();
::haxegon::Gfx_obj::__boot();
::haxegon::Input_obj::__boot();
::haxegon::Mouse_obj::__boot();
::haxegon::Music_obj::__boot();
::haxegon::Random_obj::__boot();
::haxegon::Sound_obj::__boot();
::haxegon::Text_obj::__boot();
::haxegon::embeddedassets::DefaultFont_obj::__boot();
::starling::filters::FragmentFilter_obj::__boot();
...
::starling::animation::DelayedCall_obj::__boot();
::starling::animation::Juggler_obj::__boot();
::starling::animation::Transitions_obj::__boot();
::starling::animation::Tween_obj::__boot();
::starling::core::Starling_obj::__boot();
::starling::core::StatsDisplay_obj::__boot();
::starling::display::BlendMode_obj::__boot();
::starling::display::Image_obj::__boot();
::starling::display::MeshBatch_obj::__boot();
::starling::display::Stage_obj::__boot();
::starling::events::Event_obj::__boot();
::starling::events::EnterFrameEvent_obj::__boot();
::starling::events::KeyboardEvent_obj::__boot();
::starling::events::ResizeEvent_obj::__boot();
::starling::events::Touch_obj::__boot();
::starling::events::TouchEvent_obj::__boot();
::starling::events::TouchPhase_obj::__boot();
::starling::events::TouchProcessor_obj::__boot();
::starling::filters::FilterQuad_obj::__boot();
::starling::geom::Polygon_obj::__boot();
::starling::rendering::BatchProcessor_obj::__boot();
::starling::rendering::Painter_obj::__boot();
::starling::rendering::Program_obj::__boot();
::starling::rendering::RenderState_obj::__boot();
::starling::text::TrueTypeCompositor_obj::__boot();
::starling::text::TextField_obj::__boot();
::starling::text::BitmapFont_obj::__boot();
::starling::text::CharLocation_obj::__boot();
::starling::text::MiniBitmapFont_obj::__boot();
::starling::text::TextFieldAutoSize_obj::__boot();
::starling::textures::Texture_obj::__boot();
::starling::textures::ConcretePotTexture_obj::__boot();
::starling::textures::ConcreteRectangleTexture_obj::__boot();
::starling::textures::RenderTexture_obj::__boot();
::starling::textures::TextureAtlas_obj::__boot();
::starling::textures::TextureSmoothing_obj::__boot();
::starling::utils::Align_obj::__boot();
::starling::utils::AssetManager_obj::__boot();
::starling::utils::Color_obj::__boot();
::starling::utils::MathUtil_obj::__boot();
::starling::utils::MatrixUtil_obj::__boot();
::starling::utils::Max_obj::__boot();
::starling::utils::MeshUtil_obj::__boot();
::starling::utils::Pool_obj::__boot();
::starling::utils::RectangleUtil_obj::__boot();
::starling::utils::ScaleMode_obj::__boot();
::starling::utils::SystemUtil_obj::__boot();
}
