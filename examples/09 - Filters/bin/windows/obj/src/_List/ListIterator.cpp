...
HX_DEFINE_STACK_FRAME(_hx_pos_cc1efc3911481bce_269_new,"_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","C:\\coding\\haxe\\haxe\\std/List.hx",269,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_cc1efc3911481bce_273_hasNext,"_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","C:\\coding\\haxe\\haxe\\std/List.hx",273,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_cc1efc3911481bce_276_next,"_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","C:\\coding\\haxe\\haxe\\std/List.hx",276,0xe92038c7)
namespace _List{

void ListIterator_obj::__construct( ::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_cc1efc3911481bce_269_new)
...
bool ListIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_cc1efc3911481bce_273_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_cc1efc3911481bce_276_next)
