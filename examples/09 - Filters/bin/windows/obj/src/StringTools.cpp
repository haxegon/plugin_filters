...
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_45_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","C:\\coding\\haxe\\haxe\\std/StringTools.hx",45,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_115_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","C:\\coding\\haxe\\haxe\\std/StringTools.hx",115,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_183_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","C:\\coding\\haxe\\haxe\\std/StringTools.hx",183,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_211_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","C:\\coding\\haxe\\haxe\\std/StringTools.hx",211,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_245_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","C:\\coding\\haxe\\haxe\\std/StringTools.hx",245,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_262_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","C:\\coding\\haxe\\haxe\\std/StringTools.hx",262,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_287_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","C:\\coding\\haxe\\haxe\\std/StringTools.hx",287,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_315_trim,"StringTools","trim",0x2908d066,"StringTools.trim","C:\\coding\\haxe\\haxe\\std/StringTools.hx",315,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_331_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","C:\\coding\\haxe\\haxe\\std/StringTools.hx",331,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_386_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","C:\\coding\\haxe\\haxe\\std/StringTools.hx",386,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_396_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","C:\\coding\\haxe\\haxe\\std/StringTools.hx",396,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_488_quoteUnixArg,"StringTools","quoteUnixArg",0xc59dac56,"StringTools.quoteUnixArg","C:\\coding\\haxe\\haxe\\std/StringTools.hx",488,0x9a2fa0ad)
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_521_quoteWinArg,"StringTools","quoteWinArg",0x7e16b8f2,"StringTools.quoteWinArg","C:\\coding\\haxe\\haxe\\std/StringTools.hx",521,0x9a2fa0ad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_deb041835f97eba5_506_boot,"StringTools","boot",0x1d20b7b6,"StringTools.boot","C:\\coding\\haxe\\haxe\\std/StringTools.hx",506,0x9a2fa0ad)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_45_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_115_urlDecode)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_183_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_211_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_245_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_262_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_287_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_315_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_331_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_386_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_396_hex)
...
::String StringTools_obj::quoteUnixArg(::String argument){
            	HX_GC_STACKFRAME(&_hx_pos_deb041835f97eba5_488_quoteUnixArg)
...
::String StringTools_obj::quoteWinArg(::String argument,bool escapeMetaCharacters){
            	HX_GC_STACKFRAME(&_hx_pos_deb041835f97eba5_521_quoteWinArg)
...
{
{
            	HX_STACKFRAME(&_hx_pos_deb041835f97eba5_506_boot)
