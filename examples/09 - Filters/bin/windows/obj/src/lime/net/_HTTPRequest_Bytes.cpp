...
HX_DEFINE_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_99_new,"lime.net._HTTPRequest_Bytes","new",0xc45547d0,"lime.net._HTTPRequest_Bytes.new","lime/net/HTTPRequest.hx",99,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_106_fromBytes,"lime.net._HTTPRequest_Bytes","fromBytes",0x58799e11,"lime.net._HTTPRequest_Bytes.fromBytes","lime/net/HTTPRequest.hx",106,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_125_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",125,0x339db723)
HX_LOCAL_STACK_FRAME(_hx_pos_d0a88ab7a13f72d7_111_load,"lime.net._HTTPRequest_Bytes","load",0x04fea4b6,"lime.net._HTTPRequest_Bytes.load","lime/net/HTTPRequest.hx",111,0x339db723)
namespace lime{
namespace net{

void _HTTPRequest_Bytes_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_99_new)
HXDLIN(  99)		super::__construct(uri);
            	}
...
bool _HTTPRequest_Bytes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_Bytes_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_106_fromBytes)
HXDLIN( 106)		return bytes;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(_HTTPRequest_Bytes_obj,fromBytes,return )
 ...
 ::lime::app::Future _HTTPRequest_Bytes_obj::load(::String uri){
            		...
            		void _hx_run( ::haxe::io::Bytes bytes){
            			HX_GC_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_125_load)
HXLINE( 127)			_gthis->responseData = _gthis->fromBytes(bytes);
HXLINE( 128)			promise->complete(_gthis->responseData);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_d0a88ab7a13f72d7_111_load)
HXDLIN( 111)		 ::lime::net::_HTTPRequest_Bytes _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 113)		if (hx::IsNotNull( uri )) {
HXLINE( 115)			this->uri = uri;
            		}
HXLINE( 119)		 ::lime::app::Promise promise =  ::lime::app::Promise_obj::__alloc( HX_CTX );
HXLINE( 120)		 ::lime::app::Future future = this->backend->loadData(this->uri,null());
HXLINE( 122)		future->onProgress(promise->progress_dyn());
HXLINE( 123)		future->onError(promise->error_dyn());
HXLINE( 125)		future->onComplete( ::Dynamic(new _hx_Closure_0(_gthis,promise)));
HXLINE( 132)		return promise->future;
            	}
