...
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_307_callMember,"lime.system.JNIMethod","callMember",0x1acfd846,"lime.system.JNIMethod.callMember","lime/system/JNI.hx",307,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_318_callStatic,"lime.system.JNIMethod","callStatic",0x1c15d29a,"lime.system.JNIMethod.callStatic","lime/system/JNI.hx",318,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_326_getMemberMethod,"lime.system.JNIMethod","getMemberMethod",0x7872cd23,"lime.system.JNIMethod.getMemberMethod","lime/system/JNI.hx",326,0x21970b7f)
HX_LOCAL_STACK_FRAME(_hx_pos_39b0deb1236c4593_341_getStaticMethod,"lime.system.JNIMethod","getStaticMethod",0xd67b3e77,"lime.system.JNIMethod.getStaticMethod","lime/system/JNI.hx",341,0x21970b7f)
namespace lime{
...
bool JNIMethod_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JNIMethod_obj::callMember(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_307_callMember)
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callMember,return )
 ...
 ::Dynamic JNIMethod_obj::callStatic(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_318_callStatic)
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,callStatic,return )
 ...
 ::Dynamic JNIMethod_obj::getMemberMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_326_getMemberMethod)
HXDLIN( 326)		if (useArray) {
HXLINE( 328)			return this->callMember_dyn();
            		}
            		else {
HXLINE( 332)			return ::Reflect_obj::makeVarArgs(this->callMember_dyn());
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(JNIMethod_obj,getMemberMethod,return )
 ...
 ::Dynamic JNIMethod_obj::getStaticMethod(bool useArray){
            	HX_STACKFRAME(&_hx_pos_39b0deb1236c4593_341_getStaticMethod)
HXDLIN( 341)		if (useArray) {
HXLINE( 343)			return this->callStatic_dyn();
            		}
            		else {
HXLINE( 347)			return ::Reflect_obj::makeVarArgs(this->callStatic_dyn());
            		}
