...
HX_DEFINE_STACK_FRAME(_hx_pos_8cd636468c595f96_44_new,"List","new",0xed890070,"List.new","C:\\coding\\haxe\\haxe\\std/List.hx",44,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_8cd636468c595f96_52_add,"List","add",0xed7f2231,"List.add","C:\\coding\\haxe\\haxe\\std/List.hx",52,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_8cd636468c595f96_99_pop,"List","pop",0xed8a8da1,"List.pop","C:\\coding\\haxe\\haxe\\std/List.hx",99,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_8cd636468c595f96_123_clear,"List","clear",0xd148c59d,"List.clear","C:\\coding\\haxe\\haxe\\std/List.hx",123,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_8cd636468c595f96_137_remove,"List","remove",0x4b44d634,"List.remove","C:\\coding\\haxe\\haxe\\std/List.hx",137,0xe92038c7)
HX_LOCAL_STACK_FRAME(_hx_pos_8cd636468c595f96_161_iterator,"List","iterator",0x2d4cdfde,"List.iterator","C:\\coding\\haxe\\haxe\\std/List.hx",161,0xe92038c7)

void List_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_8cd636468c595f96_44_new)
...
void List_obj::add( ::Dynamic item){
            	HX_GC_STACKFRAME(&_hx_pos_8cd636468c595f96_52_add)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,add,(void))
 ...
 ::Dynamic List_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_8cd636468c595f96_99_pop)
...
void List_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_8cd636468c595f96_123_clear)
...
bool List_obj::remove( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_8cd636468c595f96_137_remove)
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,remove,return )
 ...
 ::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_8cd636468c595f96_161_iterator)
