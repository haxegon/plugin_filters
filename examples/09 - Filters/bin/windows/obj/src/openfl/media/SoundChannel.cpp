...
HX_DEFINE_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_37_new,"openfl.media.SoundChannel","new",0xfc94e2ae,"openfl.media.SoundChannel.new","openfl/media/SoundChannel.hx",37,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_69_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",69,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_81___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",81,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_94___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",94,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_106_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",106,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_115_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",115,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_127_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",127,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_132_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",132,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_173_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",173,0xa4290000)
namespace openfl{
namespace media{

void SoundChannel_obj::__construct( ::lime::media::AudioSource source, ::openfl::media::SoundTransform soundTransform){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_37_new)
HXLINE(  39)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  41)		this->leftPeak = (int)1;
HXLINE(  42)		this->rightPeak = (int)1;
HXLINE(  44)		if (hx::IsNotNull( soundTransform )) {
HXLINE(  46)			this->_hx___soundTransform = soundTransform;
            		}
            		else {
HXLINE(  50)			this->_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE(  54)		if (hx::IsNotNull( source )) {
HXLINE(  56)			this->_hx___source = source;
HXLINE(  57)			this->_hx___source->onComplete->add(this->source_onComplete_dyn(),null(),null());
HXLINE(  58)			this->_hx___isValid = true;
HXLINE(  60)			this->_hx___source->play();
            		}
HXLINE(  64)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_69_stop)
HXLINE(  71)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE(  73)		if (!(this->_hx___isValid)) {
HXLINE(  73)			return;
            		}
HXLINE(  75)		this->_hx___source->stop();
HXLINE(  76)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_81___dispose)
HXLINE(  83)		if (!(this->_hx___isValid)) {
HXLINE(  83)			return;
            		}
HXLINE(  85)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE(  86)		this->_hx___source->dispose();
HXLINE(  87)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_94___updateTransform)
HXDLIN(  94)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_106_get_position)
HXLINE( 108)		if (!(this->_hx___isValid)) {
HXLINE( 108)			return (int)0;
            		}
HXLINE( 110)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 110)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_115_set_position)
HXLINE( 117)		if (!(this->_hx___isValid)) {
HXLINE( 117)			return (int)0;
            		}
HXLINE( 119)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 119)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 119)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_127_get_soundTransform)
HXDLIN( 127)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_132_set_soundTransform)
HXLINE( 134)		if (hx::IsNotNull( value )) {
HXLINE( 136)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 137)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 139)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 141)			if ((pan < (int)-1)) {
HXLINE( 141)				pan = (int)-1;
            			}
HXLINE( 142)			if ((pan > (int)1)) {
HXLINE( 142)				pan = (int)1;
            			}
HXLINE( 144)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 146)			if (this->_hx___isValid) {
HXLINE( 148)				this->_hx___source->set_gain(volume);
HXLINE( 150)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 151)				position->x = pan;
HXLINE( 152)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 153)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_173_source_onComplete)
HXLINE( 175)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 177)		this->_hx___dispose();
HXLINE( 178)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
