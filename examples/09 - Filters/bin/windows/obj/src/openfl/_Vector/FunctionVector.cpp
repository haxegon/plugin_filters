...
HX_DEFINE_STACK_FRAME(_hx_pos_f37013fa3e7b7067_945_new,"openfl._Vector.FunctionVector","new",0x9bdddf17,"openfl._Vector.FunctionVector.new","openfl/Vector.hx",945,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_968_concat,"openfl._Vector.FunctionVector","concat",0x3878c6bd,"openfl._Vector.FunctionVector.concat","openfl/Vector.hx",968,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_983_copy,"openfl._Vector.FunctionVector","copy",0xbf078d1e,"openfl._Vector.FunctionVector.copy","openfl/Vector.hx",983,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_990_get,"openfl._Vector.FunctionVector","get",0x9bd88f4d,"openfl._Vector.FunctionVector.get","openfl/Vector.hx",990,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1003_indexOf,"openfl._Vector.FunctionVector","indexOf",0x03bc7f00,"openfl._Vector.FunctionVector.indexOf","openfl/Vector.hx",1003,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1022_insertAt,"openfl._Vector.FunctionVector","insertAt",0x3cb1b675,"openfl._Vector.FunctionVector.insertAt","openfl/Vector.hx",1022,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1033_iterator,"openfl._Vector.FunctionVector","iterator",0x0e2c83d7,"openfl._Vector.FunctionVector.iterator","openfl/Vector.hx",1033,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1040_join,"openfl._Vector.FunctionVector","join",0xc3a80553,"openfl._Vector.FunctionVector.join","openfl/Vector.hx",1040,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1045_lastIndexOf,"openfl._Vector.FunctionVector","lastIndexOf",0xc9451aca,"openfl._Vector.FunctionVector.lastIndexOf","openfl/Vector.hx",1045,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1063_pop,"openfl._Vector.FunctionVector","pop",0x9bdf6c48,"openfl._Vector.FunctionVector.pop","openfl/Vector.hx",1063,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1078_push,"openfl._Vector.FunctionVector","push",0xc7a3e343,"openfl._Vector.FunctionVector.push","openfl/Vector.hx",1078,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1091_removeAt,"openfl._Vector.FunctionVector","removeAt",0x27ada840,"openfl._Vector.FunctionVector.removeAt","openfl/Vector.hx",1091,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1104_reverse,"openfl._Vector.FunctionVector","reverse",0x3df96f59,"openfl._Vector.FunctionVector.reverse","openfl/Vector.hx",1104,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1114_set,"openfl._Vector.FunctionVector","set",0x9be1aa59,"openfl._Vector.FunctionVector.set","openfl/Vector.hx",1114,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1129_shift,"openfl._Vector.FunctionVector","shift",0x995756f9,"openfl._Vector.FunctionVector.shift","openfl/Vector.hx",1129,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1144_slice,"openfl._Vector.FunctionVector","slice",0x9bfc2ec9,"openfl._Vector.FunctionVector.slice","openfl/Vector.hx",1144,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1151_sort,"openfl._Vector.FunctionVector","sort",0xc99af8c7,"openfl._Vector.FunctionVector.sort","openfl/Vector.hx",1151,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1158_splice,"openfl._Vector.FunctionVector","splice",0x30474325,"openfl._Vector.FunctionVector.splice","openfl/Vector.hx",1158,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1165_toJSON,"openfl._Vector.FunctionVector","toJSON",0xecb206cc,"openfl._Vector.FunctionVector.toJSON","openfl/Vector.hx",1165,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1172_toString,"openfl._Vector.FunctionVector","toString",0xb3010a95,"openfl._Vector.FunctionVector.toString","openfl/Vector.hx",1172,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1179_unshift,"openfl._Vector.FunctionVector","unshift",0x9bb119c0,"openfl._Vector.FunctionVector.unshift","openfl/Vector.hx",1179,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1197_get_length,"openfl._Vector.FunctionVector","get_length",0x7e924ad8,"openfl._Vector.FunctionVector.get_length","openfl/Vector.hx",1197,0x4a01873c)
HX_LOCAL_STACK_FRAME(_hx_pos_f37013fa3e7b7067_1202_set_length,"openfl._Vector.FunctionVector","set_length",0x820fe94c,"openfl._Vector.FunctionVector.set_length","openfl/Vector.hx",1202,0x4a01873c)
namespace openfl{
namespace _Vector{

void FunctionVector_obj::__construct( ::Dynamic length, ::Dynamic fixed,::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_945_new)
HXLINE( 947)		if (hx::IsNull( array )) {
HXLINE( 949)			array = ::cpp::VirtualArray_obj::__new();
            		}
HXLINE( 953)		this->_hx___array = array;
HXLINE( 955)		if (hx::IsNotNull( length )) {
HXLINE( 957)			this->set_length(length);
            		}
HXLINE( 961)		this->fixed = hx::IsEq( fixed,true );
            	}
...
static ::openfl::_Vector::IVector_obj _hx_openfl__Vector_FunctionVector__hx_openfl__Vector_IVector= {
	...
	(  ::Dynamic (hx::Object::*)())&::openfl::_Vector::FunctionVector_obj::toJSON_8b3ae2fb,
};

 ::Dynamic FunctionVector_obj::toJSON_8b3ae2fb() {
			return toJSON();
}
...
::Dynamic FunctionVector_obj::concat(::Dynamic a){
            	HX_GC_STACKFRAME(&_hx_pos_f37013fa3e7b7067_968_concat)
HXDLIN( 968)		if (hx::IsNull( a )) {
HXLINE( 970)			return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->copy());
            		}
            		else {
HXLINE( 974)			::cpp::VirtualArray _hx_tmp = this->_hx___array;
HXDLIN( 974)			return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),_hx_tmp->concat(hx::TCast<  ::openfl::_Vector::FunctionVector >::cast(a)->_hx___array));
            		}
...
::Dynamic FunctionVector_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_f37013fa3e7b7067_983_copy)
HXDLIN( 983)		bool _hx_tmp = this->fixed;
HXDLIN( 983)		return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),_hx_tmp,this->_hx___array->copy());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FunctionVector_obj,copy,return )
 ...
 ::Dynamic FunctionVector_obj::get(int index){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_990_get)
HXDLIN( 990)		if ((index >= this->_hx___array->get_length())) {
HXLINE( 992)			return null();
            		}
            		else {
HXLINE( 996)			return this->_hx___array->__get(index);
            		}
...
int FunctionVector_obj::indexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1003_indexOf)
HXLINE(1005)		{
HXLINE(1005)			int _g1 = from;
HXDLIN(1005)			int _g = this->_hx___array->get_length();
HXDLIN(1005)			while((_g1 < _g)){
HXLINE(1005)				_g1 = (_g1 + (int)1);
HXDLIN(1005)				int i = (_g1 - (int)1);
HXLINE(1007)				if (::Reflect_obj::compareMethods(this->_hx___array->__get(i),x)) {
HXLINE(1009)					return i;
            				}
            			}
            		}
HXLINE(1015)		return (int)-1;
            	}
...
void FunctionVector_obj::insertAt(int index, ::Dynamic element){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1022_insertAt)
HXDLIN(1022)		bool _hx_tmp;
HXDLIN(1022)		if (!(!(this->fixed))) {
HXDLIN(1022)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXDLIN(1022)			_hx_tmp = true;
            		}
HXDLIN(1022)		if (_hx_tmp) {
HXLINE(1024)			this->_hx___array->insert(index,element);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,insertAt,(void))
 ...
 ::Dynamic FunctionVector_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1033_iterator)
HXDLIN(1033)		return this->_hx___array->iterator();
            	}
...
::String sep = __o_sep.Default(HX_HCSTRING(",","\x2c","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1040_join)
HXDLIN(1040)		return this->_hx___array->join(sep);
            	}
...
int FunctionVector_obj::lastIndexOf( ::Dynamic x, ::Dynamic __o_from){
 ::Dynamic from = __o_from.Default(0);
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1045_lastIndexOf)
HXLINE(1047)		int i = (this->_hx___array->get_length() - (int)1);
HXLINE(1049)		while(hx::IsGreaterEq( i,from )){
HXLINE(1051)			if (::Reflect_obj::compareMethods(this->_hx___array->__get(i),x)) {
HXLINE(1051)				return i;
            			}
HXLINE(1052)			i = (i - (int)1);
            		}
HXLINE(1056)		return (int)-1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,lastIndexOf,return )
 ...
 ::Dynamic FunctionVector_obj::pop(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1063_pop)
HXDLIN(1063)		if (!(this->fixed)) {
HXLINE(1065)			return this->_hx___array->pop();
            		}
            		else {
...
int FunctionVector_obj::push( ::Dynamic x){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1078_push)
HXDLIN(1078)		if (!(this->fixed)) {
HXLINE(1080)			return this->_hx___array->push(x);
            		}
            		else {
HXLINE(1084)			return this->_hx___array->get_length();
            		}
HXLINE(1078)		return (int)0;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FunctionVector_obj,push,return )
 ...
 ::Dynamic FunctionVector_obj::removeAt(int index){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1091_removeAt)
HXLINE(1093)		bool _hx_tmp;
HXDLIN(1093)		if (!(!(this->fixed))) {
HXLINE(1093)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXLINE(1093)			_hx_tmp = true;
            		}
HXDLIN(1093)		if (_hx_tmp) {
HXLINE(1095)			return this->_hx___array->splice(index,(int)1)->__get((int)0);
            		}
...
::Dynamic FunctionVector_obj::reverse(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1104_reverse)
HXLINE(1106)		this->_hx___array->reverse();
HXLINE(1107)		return hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FunctionVector_obj,reverse,return )
 ...
 ::Dynamic FunctionVector_obj::set(int index, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1114_set)
HXDLIN(1114)		bool _hx_tmp;
HXDLIN(1114)		if (!(!(this->fixed))) {
HXDLIN(1114)			_hx_tmp = (index < this->_hx___array->get_length());
            		}
            		else {
HXDLIN(1114)			_hx_tmp = true;
            		}
HXDLIN(1114)		if (_hx_tmp) {
HXLINE(1116)			return (this->_hx___array->set(index,value));
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC2(FunctionVector_obj,set,return )
 ...
 ::Dynamic FunctionVector_obj::shift(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1129_shift)
HXDLIN(1129)		if (!(this->fixed)) {
HXLINE(1131)			return this->_hx___array->shift();
            		}
            		else {
HXLINE(1135)			return null();
            		}
...
::Dynamic FunctionVector_obj::slice( ::Dynamic __o_startIndex, ::Dynamic __o_endIndex){
 ...
 ::Dynamic endIndex = __o_endIndex.Default(16777215);
            	HX_GC_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1144_slice)
HXDLIN(1144)		return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->slice(startIndex,endIndex));
            	}
...
void FunctionVector_obj::sort( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1151_sort)
HXDLIN(1151)		this->_hx___array->sort(f);
            	}
...
::Dynamic FunctionVector_obj::splice(int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1158_splice)
HXDLIN(1158)		return  ::openfl::_Vector::FunctionVector_obj::__alloc( HX_CTX ,null(),null(),this->_hx___array->splice(pos,len));
            	}
...
::cpp::VirtualArray FunctionVector_obj::toJSON(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1165_toJSON)
HXDLIN(1165)		return this->_hx___array;
            	}
...
::String FunctionVector_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1172_toString)
HXDLIN(1172)		if (hx::IsNotNull( this->_hx___array )) {
HXDLIN(1172)			return this->_hx___array->toString();
            		}
            		else {
HXDLIN(1172)			return null();
            		}
HXDLIN(1172)		return null();
            	}
...
void FunctionVector_obj::unshift( ::Dynamic x){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1179_unshift)
HXDLIN(1179)		if (!(this->fixed)) {
HXLINE(1181)			this->_hx___array->unshift(x);
            		}
            	}
...
int FunctionVector_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1197_get_length)
HXDLIN(1197)		return this->_hx___array->get_length();
            	}
...
int FunctionVector_obj::set_length(int value){
            	HX_STACKFRAME(&_hx_pos_f37013fa3e7b7067_1202_set_length)
HXLINE(1204)		if (!(this->fixed)) {
HXLINE(1208)			_hx_array_set_size_exact(this->_hx___array,value);
            		}
HXLINE(1237)		return this->_hx___array->get_length();
            	}
