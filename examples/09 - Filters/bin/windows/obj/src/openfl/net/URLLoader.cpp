...
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_201_httpRequest_onError,"openfl.net.URLLoader","httpRequest_onError",0x8f111376,"openfl.net.URLLoader.httpRequest_onError","openfl/net/URLLoader.hx",201,0x11daec0d)
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_222_httpRequest_onProgress,"openfl.net.URLLoader","httpRequest_onProgress",0xf5cd30bf,"openfl.net.URLLoader.httpRequest_onProgress","openfl/net/URLLoader.hx",222,0x11daec0d)
namespace openfl{
namespace net{
...
HXLINE( 180)		this->_hx___httpRequest->__SetField(HX_("followRedirects",26,5a,40,75),request->followRedirects,hx::paccDynamic);
HXLINE( 181)		this->_hx___httpRequest->__SetField(HX_("timeout",a1,1a,f7,d8),::Std_obj::_hx_int(request->idleTimeout),hx::paccDynamic);
HXLINE( 182)		this->_hx___httpRequest->__SetField(HX_("withCredentials",56,86,c4,ca),request->manageCookies,hx::paccDynamic);
HXLINE( 185)		::String userAgent = request->userAgent;
HXLINE( 186)		if (hx::IsNull( userAgent )) {
HXLINE( 186)			userAgent = HX_("Mozilla/5.0 (Windows; U; en) AppleWebKit/420+ (KHTML, like Gecko) OpenFL/1.0",2f,7c,ab,e1);
            		}
HXLINE( 188)		this->_hx___httpRequest->__SetField(HX_("userAgent",7a,f0,12,c8),request->userAgent,hx::paccDynamic);
HXLINE( 189)		this->_hx___httpRequest->__SetField(HX_("enableResponseHeaders",82,32,47,05),true,hx::paccDynamic);
            	}
...
void URLLoader_obj::httpRequest_onError( ::Dynamic error){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_201_httpRequest_onError)
HXLINE( 203)		this->_hx___dispatchStatus();
HXLINE( 205)		if (hx::IsEq( error,(int)403 )) {
HXLINE( 207)			 ::openfl::events::SecurityErrorEvent event =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,HX_("securityError",e8,28,7c,a2),null(),null(),null(),null());
HXLINE( 208)			event->text = ::Std_obj::string(error);
HXLINE( 209)			this->dispatchEvent(event);
            		}
            		else {
HXLINE( 213)			 ::openfl::events::IOErrorEvent event1 =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 214)			event1->text = ::Std_obj::string(error);
HXLINE( 215)			this->dispatchEvent(event1);
            		}
            	}
...
void URLLoader_obj::httpRequest_onProgress(int bytesLoaded,int bytesTotal){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_222_httpRequest_onProgress)
HXLINE( 224)		 ::openfl::events::ProgressEvent event =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
HXLINE( 225)		event->bytesLoaded = bytesLoaded;
HXLINE( 226)		event->bytesTotal = bytesTotal;
HXLINE( 227)		this->dispatchEvent(event);
            	}
