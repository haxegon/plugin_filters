...
HX_DEFINE_STACK_FRAME(_hx_pos_7e11e121a091958b_25_new,"openfl._internal.renderer.RenderSession","new",0x2c15cbb7,"openfl._internal.renderer.RenderSession.new","openfl/_internal/renderer/RenderSession.hx",25,0x8a77a218)
namespace openfl{
namespace _internal{
namespace renderer{

void RenderSession_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_7e11e121a091958b_25_new)
HXLINE(  47)		this->activeTextures = (int)0;
HXLINE(  63)		this->allowSmoothing = true;
HXLINE(  64)		this->clearRenderDirty = false;
            	}
...
void RenderSession_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(renderType,"renderType");
...
void RenderSession_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(renderType,"renderType");
...
hx::Val RenderSession_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"renderType") ) { return hx::Val( renderType ); }
		break;
	case 11:
...
hx::Val RenderSession_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"renderType") ) { renderType=inValue.Cast<  ::lime::graphics::RendererType >(); return inValue; }
		break;
	case 11:
...
void RenderSession_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("renderType","\x30","\xed","\x12","\xea"));
...
static hx::StorageInfo RenderSession_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::graphics::RendererType*/ ,(int)offsetof(RenderSession_obj,renderType),HX_HCSTRING("renderType","\x30","\xed","\x12","\xea")},
...
static ::String RenderSession_obj_sMemberFields[] = {
	...
	HX_HCSTRING("renderType","\x30","\xed","\x12","\xea"),
