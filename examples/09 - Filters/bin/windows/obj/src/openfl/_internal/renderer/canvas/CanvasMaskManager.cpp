...
HXDLIN(  51)		if (!(object->_hx___cacheBitmapRender)) {
HXLINE(  51)			_hx_tmp1 = hx::IsNotNull( object->_hx___mask );
            		}
            		else {
...
HXDLIN(  83)		if (!(object->_hx___cacheBitmapRender)) {
HXLINE(  83)			_hx_tmp = hx::IsNotNull( object->_hx___mask );
            		}
            		else {
