...
HXDLIN(  32)		this->_registers =  ::openfl::_Vector::AbstractVector_obj::__alloc( HX_CTX , ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,(int)4096,fixed,null()),null());
...
HXLINE(  53)				::openfl::_Vector::IVector_obj::set(this->_registers->data,c,((Float)-999999999.0));
            			}
            		}
            	}
...
bool Context3DStateCache_obj::updateRegisters( ::openfl::_Vector::AbstractVector mTemp,int startRegister,int numRegisters){
...
hx::Val Context3DStateCache_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_registers") ) { _registers=inValue.Cast<  ::openfl::_Vector::AbstractVector >(); return inValue; }
		break;
	case 12:
...
static hx::StorageInfo Context3DStateCache_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_Vector::AbstractVector*/ ,(int)offsetof(Context3DStateCache_obj,_registers),HX_HCSTRING("_registers","\x71","\x6c","\xb4","\x16")},
