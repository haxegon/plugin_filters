...
HXDLIN(  31)		if (hx::IsNotNull( bitmap->_hx___bitmapData )) {
HXLINE(  31)			_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            		}
            		else {
...
HXLINE(  51)			 ::Dynamic surface = bitmap->_hx___bitmapData->getSurface();
