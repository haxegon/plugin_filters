...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_85_clone,"openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",85,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_98_toString,"openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",98,0xd3783172)
...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_103_updateAfterEvent,"openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",103,0xd3783172)
...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_85_clone)
HXLINE(  87)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
HXLINE(  88)		event->target = this->target;
HXLINE(  89)		event->currentTarget = this->currentTarget;
HXLINE(  90)		event->eventPhase = this->eventPhase;
HXLINE(  91)		return event;
            	}


::String MouseEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_98_toString)
HXDLIN(  98)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_103_updateAfterEvent)
            	}
