...
HXLINE(  33)		::openfl::_internal::stage3D::opengl::GLVideoTexture_obj::create(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession);
            	}
...
HXDLIN(  72)		return ::openfl::_internal::stage3D::opengl::GLVideoTexture_obj::getTexture(hx::ObjectPtr<OBJ_>(this),this->_hx___context->_hx___renderSession);
            	}
