...
HX_DEFINE_STACK_FRAME(_hx_pos_6ccc15e272cca89a_932_new,"openfl.utils._AGALMiniAssembler.Register","new",0x1846d8af,"openfl.utils._AGALMiniAssembler.Register.new","openfl/utils/AGALMiniAssembler.hx",932,0x125eff83)
HX_LOCAL_STACK_FRAME(_hx_pos_6ccc15e272cca89a_945_toString,"openfl.utils._AGALMiniAssembler.Register","toString",0xe0b049fd,"openfl.utils._AGALMiniAssembler.Register.toString","openfl/utils/AGALMiniAssembler.hx",945,0x125eff83)
namespace openfl{
namespace utils{
namespace _AGALMiniAssembler{

void Register_obj::__construct(::String name,::String longName,int emitCode,int range,int flags){
            	HX_STACKFRAME(&_hx_pos_6ccc15e272cca89a_932_new)
HXLINE( 934)		this->name = name;
HXLINE( 935)		this->longName = longName;
HXLINE( 936)		this->emitCode = emitCode;
HXLINE( 937)		this->range = range;
HXLINE( 938)		this->flags = flags;
            	}
...
::String Register_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_6ccc15e272cca89a_945_toString)
HXDLIN( 945)		::String _hx_tmp = ((((HX_("[Register name=\"",52,ca,95,64) + this->name) + HX_("\", longName=\"",82,59,39,e3)) + this->longName) + HX_("\", emitCode=",47,55,e6,cb));
HXDLIN( 945)		int _hx_int = this->emitCode;
HXDLIN( 945)		Float _hx_tmp1;
HXDLIN( 945)		if ((_hx_int < (int)0)) {
HXDLIN( 945)			_hx_tmp1 = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXDLIN( 945)			_hx_tmp1 = (_hx_int + ((Float)0.0));
            		}
HXDLIN( 945)		::String _hx_tmp2 = ((_hx_tmp + ::Std_obj::string(_hx_tmp1)) + HX_(", range=",54,d5,eb,be));
HXDLIN( 945)		int int1 = this->range;
HXDLIN( 945)		Float _hx_tmp3;
HXDLIN( 945)		if ((int1 < (int)0)) {
HXDLIN( 945)			_hx_tmp3 = (((Float)4294967296.0) + int1);
            		}
            		else {
HXDLIN( 945)			_hx_tmp3 = (int1 + ((Float)0.0));
            		}
HXDLIN( 945)		::String _hx_tmp4 = ((_hx_tmp2 + ::Std_obj::string(_hx_tmp3)) + HX_(", flags=",8a,28,74,3f));
HXDLIN( 945)		int int2 = this->flags;
HXDLIN( 945)		Float _hx_tmp5;
HXDLIN( 945)		if ((int2 < (int)0)) {
HXDLIN( 945)			_hx_tmp5 = (((Float)4294967296.0) + int2);
            		}
            		else {
HXDLIN( 945)			_hx_tmp5 = (int2 + ((Float)0.0));
            		}
HXDLIN( 945)		return ((_hx_tmp4 + ::Std_obj::string(_hx_tmp5)) + HX_("]",5d,00,00,00));
            	}
