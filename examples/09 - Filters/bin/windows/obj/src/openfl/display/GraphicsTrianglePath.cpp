...
void GraphicsTrianglePath_obj::__construct( ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling){
...
hx::ObjectPtr< GraphicsTrianglePath_obj > GraphicsTrianglePath_obj::__new( ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling) {
...
hx::ObjectPtr< GraphicsTrianglePath_obj > GraphicsTrianglePath_obj::__alloc(hx::Ctx *_hx_ctx, ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling) {
...
hx::Val GraphicsTrianglePath_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"indices") ) { indices=inValue.Cast<  ::openfl::_Vector::AbstractVector >(); return inValue; }
		if (HX_FIELD_EQ(inName,"uvtData") ) { uvtData=inValue.Cast<  ::openfl::_Vector::AbstractVector >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"vertices") ) { vertices=inValue.Cast<  ::openfl::_Vector::AbstractVector >(); return inValue; }
		break;
	case 18:
...
static hx::StorageInfo GraphicsTrianglePath_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_Vector::AbstractVector*/ ,(int)offsetof(GraphicsTrianglePath_obj,indices),HX_HCSTRING("indices","\x27","\x47","\x54","\xe3")},
	{hx::fsObject /*::openfl::_Vector::AbstractVector*/ ,(int)offsetof(GraphicsTrianglePath_obj,uvtData),HX_HCSTRING("uvtData","\xbd","\xa6","\x23","\x27")},
	{hx::fsObject /*::openfl::_Vector::AbstractVector*/ ,(int)offsetof(GraphicsTrianglePath_obj,vertices),HX_HCSTRING("vertices","\xf9","\xbf","\x15","\x6a")},
