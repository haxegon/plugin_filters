...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_907_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",907,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_907_new)
HXLINE( 909)		this->initFrame = initFrame;
HXLINE( 910)		this->initFrameObjectID = initFrameObjectID;
HXLINE( 911)		this->characterID = characterID;
HXLINE( 912)		this->depth = depth;
HXLINE( 913)		this->displayObject = displayObject;
HXLINE( 914)		this->clipDepth = clipDepth;
            	}
