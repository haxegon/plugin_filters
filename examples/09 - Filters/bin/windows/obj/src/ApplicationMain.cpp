...
HXLINE(  23)		::String projectName = HX_("filters",bb,a1,46,09);
HXLINE(  25)		 ::Dynamic config =  ::Dynamic(hx::Anon_obj::Create(9)
            			->setFixed(0,HX_("company",3d,15,69,83),HX_("Haxegon",c0,18,ce,d5))
            			->setFixed(1,HX_("build",2e,db,ea,ba),HX_("42",7e,2d,00,00))
            			->setFixed(2,HX_("windows",83,de,74,e8),::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(22)
            				...
            				->setFixed(9,HX_("height",e7,07,4c,02),(int)720)
            				->setFixed(10,HX_("title",98,15,3b,10),HX_("Filters",9b,c9,97,d6))
            				...
            				->setFixed(16,HX_("vsync",d1,2d,a8,3d),true)
            			...
            			->setFixed(5,HX_("packageName",f1,04,ad,04),HX_("com.yournamehere.filters",08,17,3a,ad))
            			->setFixed(6,HX_("file",7c,ce,bb,43),HX_("filters",bb,a1,46,09))
            			->setFixed(7,HX_("name",4b,72,ff,48),HX_("Filters",9b,c9,97,d6))
