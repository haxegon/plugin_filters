...
class HXCPP_CLASS_ATTRIBUTES Matrix3D_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::openfl::_Vector::AbstractVector v);
		...
		static hx::ObjectPtr< Matrix3D_obj > __new( ::openfl::_Vector::AbstractVector v);
		static hx::ObjectPtr< Matrix3D_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_Vector::AbstractVector v);
		...
		static ::Dynamic _hx___getAxisRotation_dyn();
		 ...
		 ::openfl::_Vector::AbstractVector rawData;
		...
		void copyRawDataFrom( ::openfl::_Vector::AbstractVector vector,hx::Null< int >  index,hx::Null< bool >  transpose);
		::Dynamic copyRawDataFrom_dyn();

		void copyRawDataTo( ::openfl::_Vector::AbstractVector vector,hx::Null< int >  index,hx::Null< bool >  transpose);
		...
		::Dynamic copyToMatrix3D_dyn();
		 ...
		 ::openfl::_Vector::AbstractVector decompose( ::Dynamic orientationStyle);
		...
		bool recompose( ::openfl::_Vector::AbstractVector components, ::Dynamic orientationStyle);
		::Dynamic recompose_dyn();

		 ::openfl::geom::Vector3D transformVector( ::openfl::geom::Vector3D v);
		::Dynamic transformVector_dyn();

		void transformVectors( ::openfl::_Vector::AbstractVector vin, ::openfl::_Vector::AbstractVector vout);
