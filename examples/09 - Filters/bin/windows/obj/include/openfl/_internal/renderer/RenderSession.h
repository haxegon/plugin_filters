...
HX_DECLARE_STACK_FRAME(_hx_pos_7e11e121a091958b_25_new)
...
HXLINE(  47)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->activeTextures = (int)0;
HXLINE(  63)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->allowSmoothing = true;
HXLINE(  64)		( ( ::openfl::_internal::renderer::RenderSession)(__this) )->clearRenderDirty = false;
            	}
		...
		bool clearRenderDirty;
		 ...
		 ::lime::graphics::RendererType renderType;
		bool roundPixels;
