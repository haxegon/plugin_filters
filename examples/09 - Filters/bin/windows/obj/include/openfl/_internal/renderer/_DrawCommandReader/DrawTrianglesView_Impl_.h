...
class HXCPP_CLASS_ATTRIBUTES DrawTrianglesView_Impl__obj : public hx::Object
{
	...
	public:
		...
		static  ::openfl::_Vector::AbstractVector get_vertices( ::openfl::_internal::renderer::DrawCommandReader this1);
		static ::Dynamic get_vertices_dyn();

		static  ::openfl::_Vector::AbstractVector get_indices( ::openfl::_internal::renderer::DrawCommandReader this1);
		static ::Dynamic get_indices_dyn();

		static  ::openfl::_Vector::AbstractVector get_uvtData( ::openfl::_internal::renderer::DrawCommandReader this1);
