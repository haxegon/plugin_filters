...
class HXCPP_CLASS_ATTRIBUTES TextEngine_obj : public hx::Object
{
	...
	public:
		...
		bool embedFonts;
		 ::Dynamic gridFitType;
		Float height;
		 ::openfl::_Vector::AbstractVector layoutGroups;
		 ::openfl::_Vector::AbstractVector lineAscents;
		 ::openfl::_Vector::AbstractVector lineBreaks;
		 ::openfl::_Vector::AbstractVector lineDescents;
		 ::openfl::_Vector::AbstractVector lineLeadings;
		 ::openfl::_Vector::AbstractVector lineHeights;
		 ::openfl::_Vector::AbstractVector lineWidths;
		int maxChars;
		int maxScrollH;
		int maxScrollV;
		bool multiline;
		...
		::String text;
		Float textHeight;
		 ::openfl::_Vector::AbstractVector textFormatRanges;
		Float textWidth;
		 ::Dynamic type;
		Float width;
		bool wordWrap;
