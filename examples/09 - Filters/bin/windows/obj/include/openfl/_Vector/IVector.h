...
class HXCPP_CLASS_ATTRIBUTES IVector_obj {
	public:
		...
		static inline void unshift( ::Dynamic _hx_, ::Dynamic x) {
		 ...
		 ::Dynamic (hx::Object :: *_hx_toJSON)(); 
		static inline  ::Dynamic toJSON( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( static_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_toJSON)();
		}
};
