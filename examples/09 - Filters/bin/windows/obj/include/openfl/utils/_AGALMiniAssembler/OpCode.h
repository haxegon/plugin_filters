...
HX_DECLARE_STACK_FRAME(_hx_pos_b6bb58d9c0266c23_896_new)
...
HXLINE( 898)		( ( ::openfl::utils::_AGALMiniAssembler::OpCode)(__this) )->name = name;
HXLINE( 899)		( ( ::openfl::utils::_AGALMiniAssembler::OpCode)(__this) )->numRegister = numRegister;
HXLINE( 900)		( ( ::openfl::utils::_AGALMiniAssembler::OpCode)(__this) )->emitCode = emitCode;
HXLINE( 901)		( ( ::openfl::utils::_AGALMiniAssembler::OpCode)(__this) )->flags = flags;
            	}
