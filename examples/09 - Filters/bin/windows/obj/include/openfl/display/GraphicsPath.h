...
class HXCPP_CLASS_ATTRIBUTES GraphicsPath_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::openfl::_Vector::AbstractVector commands, ::openfl::_Vector::AbstractVector data, ::Dynamic __o_winding);
		...
		static hx::ObjectPtr< GraphicsPath_obj > __new( ::openfl::_Vector::AbstractVector commands, ::openfl::_Vector::AbstractVector data, ::Dynamic __o_winding);
		static hx::ObjectPtr< GraphicsPath_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_Vector::AbstractVector commands, ::openfl::_Vector::AbstractVector data, ::Dynamic __o_winding);
		...
		static Float SIN45;
		static Float TAN22;
		 ::openfl::_Vector::AbstractVector commands;
		 ::openfl::_Vector::AbstractVector data;
		 ::Dynamic winding;
