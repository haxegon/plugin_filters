...
class HXCPP_CLASS_ATTRIBUTES GraphicsTrianglePath_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling);
		...
		static hx::ObjectPtr< GraphicsTrianglePath_obj > __new( ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling);
		static hx::ObjectPtr< GraphicsTrianglePath_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_Vector::AbstractVector vertices, ::openfl::_Vector::AbstractVector indices, ::openfl::_Vector::AbstractVector uvtData, ::Dynamic __o_culling);
		...
		::String __ToString() const { return HX_HCSTRING("GraphicsTrianglePath","\x18","\x0a","\x69","\x29"); }
		 ...
		 ::Dynamic culling;
		 ::openfl::_Vector::AbstractVector indices;
		 ::openfl::_Vector::AbstractVector uvtData;
		 ::openfl::_Vector::AbstractVector vertices;
