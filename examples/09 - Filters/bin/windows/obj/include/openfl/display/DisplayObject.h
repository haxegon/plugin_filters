...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		virtual void _hx___readGraphicsData( ::openfl::_Vector::AbstractVector graphicsData,bool recurse);
		...
		virtual void _hx___renderGLMask( ::openfl::_internal::renderer::RenderSession renderSession);
