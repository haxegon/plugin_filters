...
class HXCPP_CLASS_ATTRIBUTES BitmapData_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic getTexture_dyn();
		 ...
		 ::openfl::_Vector::AbstractVector getVector( ::openfl::geom::Rectangle rect);
		...
		void setVector( ::openfl::geom::Rectangle rect, ::openfl::_Vector::AbstractVector inputVector);
		...
		void _hx___renderGLMask( ::openfl::_internal::renderer::RenderSession renderSession);
